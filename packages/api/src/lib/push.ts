...
import { buildPushCopy } from './push-copy.js';

// The vague-copy builder is a pure module (`lib/push-copy.ts`) so the worker
// queue consumer can import it without pulling this Postgres-backed module
// into the worker bundle. Re-export keeps the legacy call sites unchanged.
export { buildPushCopy };
